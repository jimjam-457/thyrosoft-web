...
console.log('🔧 Adding Tests and Test Packages API endpoints to server.js...');

// Read the server.js file
let content = fs.readFileSync(serverPath, 'utf8');

// Add tests API endpoints before the final closing
...
console.log('✅ Added Tests and Test Packages API endpoints to server.js!');
console.log('✅ Added complete CRUD operations for both tables');
